...
BEGIN
    IF TG_OP = 'INSERT' THEN
        ...
        VALUES (NEW.id, NEW.gender, NEW.age_group, NEW.household_income, NEW.education, NEW.region, 'I')
...
AFTER INSERT OR UPDATE OR DELETE ON public.respondent
FOR EACH ROW EXECUTE FUNCTION fn_dim_respondent();